...
<template>
  <c-card>
    <c-input-text v-model:value="rawJwt" label="要解码的JWT" :validation="validation" placeholder="在此粘贴您的令牌..." rows="5" multiline raw-text autofocus mb-3 />
