...
<template>
  <div flex flex-col gap-4>
    <c-input-text v-model:value="plainText" multiline raw-text placeholder="输入要计算哈希的纯文本..." rows="3" autosize autofocus label="要计算哈希的纯文本" />
    ...
    <div flex gap-2>
      ...
      <c-select
        ...
        :options="[
          ...
          {
            label: 'Base64-url (URL安全字符)',
            value: 'Base64url',
          },
        ]"
      />
    </div>
    <input-copyable v-model:value="hmac" type="textarea" placeholder="HMAC结果..." label="您文本的HMAC" />
